 ...
 *   <li>{@link uk.ac.york.cs.eng2.offers.impl.ProductImpl#getCategories <em>Categories</em>}</li>
...
public class ProductImpl extends MinimalEObjectImpl.Container implements Product {
	...
	public EList<Category> getCategories() {
		if (categories == null) {
			categories = new EObjectWithInverseResolvingEList.ManyInverse<Category>(Category.class, this, OffersPackage.PRODUCT__CATEGORIES, OffersPackage.CATEGORY__PRODUCTS);
		}
		return categories;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case OffersPackage.PRODUCT__CATEGORIES:
