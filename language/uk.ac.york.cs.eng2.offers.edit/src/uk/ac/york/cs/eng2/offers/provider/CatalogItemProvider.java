...
/**
 * This is the item provider adapter for a {@link uk.ac.york.cs.eng2.offers.Catalog} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CatalogItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(OffersPackage.Literals.CATALOG__PRODUCTS);
			childrenFeatures.add(OffersPackage.Literals.CATALOG__CATEGORIES);
			childrenFeatures.add(OffersPackage.Literals.CATALOG__TAGS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(OffersPackage.Literals.CATALOG__PRODUCTS,
				 OffersFactory.eINSTANCE.createProduct()));

		newChildDescriptors.add
			(createChildParameter
				(OffersPackage.Literals.CATALOG__CATEGORIES,
				 OffersFactory.eINSTANCE.createCategory()));

		newChildDescriptors.add
			(createChildParameter
				(OffersPackage.Literals.CATALOG__TAGS,
