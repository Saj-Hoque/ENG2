...
public class PricingControllerTest {
    ...
    void calculatePricingValid() {
        ...
        List<PricingRequestDTO.ProductOrder> basket = new ArrayList<>();
        ...
        PricingRequestDTO.ProductOrder order1 = new PricingRequestDTO.ProductOrder();
        ...
        PricingRequestDTO.ProductOrder order2 = new PricingRequestDTO.ProductOrder();
        ...
        PricingRequestDTO.ProductOrder order3 = new PricingRequestDTO.ProductOrder();
        ...
        HttpResponse<PricingResponseDTO> response = pricingClient.priceCalculator(request);

        PricingResponseDTO.ProductPrice productPrice1 = response.body().getProductPrices().get(0);
        ...
        PricingResponseDTO.ProductPrice productPrice2 = response.body().getProductPrices().get(1);
        ...
        PricingResponseDTO.ProductPrice productPrice3 = response.body().getProductPrices().get(2);
    ...
    void calculatePricingInvalid() {
        ...
        PricingRequestDTO.ProductOrder order = new PricingRequestDTO.ProductOrder();
